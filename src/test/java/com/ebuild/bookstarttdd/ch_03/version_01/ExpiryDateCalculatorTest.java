...
public class ExpiryDateCalculatorTest {
    ...
    void 이만원_이상_납부하면_비례해서_만료일_계산() {
        ...
        assertExpiryDate(payData, LocalDate.of(2019, 3, 31));
        assertExpiryDate(payData2, LocalDate.of(2019, 5, 31));
        assertExpiryDate(payData3, LocalDate.of(2019, 7, 30));
        assertExpiryDate(payData4, LocalDate.of(2019, 9, 30));
    }
    ...
    @Test
    void 십만원이상을_납부하면_비례해서_년단위로_만료일계산() {
        PayData payData = PayData.builder()
        ...
        assertExpiryDate(payData2, LocalDate.of(2020, 1, 31));
        assertExpiryDate(payData3, LocalDate.of(2021, 2, 28));
        assertExpiryDate(payData4, LocalDate.of(2021, 2, 28));
    }
